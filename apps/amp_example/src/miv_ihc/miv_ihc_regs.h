...
#define MIV_IHC_REGS_CH_CTRL_ACKIE_NS_MASK (BIT_MASK_1_BITS)
#define MIV_IHC_REGS_CH_CTRL_ACKIE_MASK \
    (MIV_IHC_REGS_CH_CTRL_ACKIE_NS_MASK << MIV_IHC_REGS_CH_CTRL_ACKIE_SHIFT)
...
#define MIV_IHC_REGS_CH_CTRL_ACKCLR_NS_MASK (BIT_MASK_1_BITS)
#define MIV_IHC_REGS_CH_CTRL_ACKCLR_MASK \
    (MIV_IHC_REGS_CH_CTRL_ACKCLR_NS_MASK << MIV_IHC_REGS_CH_CTRL_ACKCLR_SHIFT)
...
#define MIV_IHC_REGS_CH_CTRL_ACK_NS_MASK (BIT_MASK_1_BITS)
#define MIV_IHC_REGS_CH_CTRL_ACK_MASK \
    (MIV_IHC_REGS_CH_CTRL_ACK_NS_MASK << MIV_IHC_REGS_CH_CTRL_ACK_SHIFT)
...
#define MIV_IHC_REGS_CH_CTRL_MPIE_NS_MASK (BIT_MASK_1_BITS)
#define MIV_IHC_REGS_CH_CTRL_MPIE_MASK \
    (MIV_IHC_REGS_CH_CTRL_MPIE_NS_MASK << MIV_IHC_REGS_CH_CTRL_MPIE_SHIFT)
...
#define MIV_IHC_REGS_CH_CTRL_MP_NS_MASK (BIT_MASK_1_BITS)
#define MIV_IHC_REGS_CH_CTRL_MP_MASK \
    (MIV_IHC_REGS_CH_CTRL_MP_NS_MASK << MIV_IHC_REGS_CH_CTRL_MP_SHIFT)
...
#define MIV_IHC_REGS_CH_CTRL_RMP_NS_MASK (BIT_MASK_1_BITS)
#define MIV_IHC_REGS_CH_CTRL_RMP_MASK \
    (MIV_IHC_REGS_CH_CTRL_RMP_NS_MASK << MIV_IHC_REGS_CH_CTRL_RMP_SHIFT)
...
#define MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_OUT_NS_MASK (BIT_MASK_16_BITS)
#define MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_OUT_MASK \
    (MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_OUT_NS_MASK << MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_OUT_SHIFT)
 ...
 */
#define MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_IN_SHIFT   (8U) // changed
#define MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_IN_NS_MASK (BIT_MASK_8_BITS)
#define MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_IN_MASK \
    (MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_IN_NS_MASK << MIV_IHC_REGS_MESSAGE_SIZE_MESSAGE_IN_SHIFT)

/* Core And its Channel Addresses *******/

#define MIV_IHC_REGS_IRQ_STATUS_SHIFT      (0U)
#define MIV_IHC_REGS_IRQ_STATUS_NS_MASK    (BIT_MASK_12_BITS)

#define MIV_IHC_REGS_IRQ_ENABLE_MASK       (0x0FFFU)
#define MIV_IHC_REGS_IRQ_DISABLE_MASK      (0x0U)

#define MIV_IHC_REGS_MP_IRQ_STATUS_MASK    (1U)

#define MIV_IHC_REGS_MC_IRQ_STATUS_SHIFT   (1U)
#define MIV_IHC_REGS_MC_IRQ_STATUS_NS_MASK (BIT_MASK_1_BITS)
#define MIV_IHC_REGS_MC_IRQ_STATUS_MASK \
    (MIV_IHC_REGS_MC_IRQ_STATUS_NS_MASK << MIV_IHC_REGS_MC_IRQ_STATUS_SHIFT)
